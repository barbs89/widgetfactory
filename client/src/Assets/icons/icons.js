...
const FontBoldIcon = () => (
  <svg viewBox="0 0 39 40" width="40" height="40">
    ...
    <path
      className="IconFeature"
      d="M13.86,28V10.94h6a7.87,7.87,0,0,1,4.71,1.19,4.05,4.05,0,0,1,1.6,3.48,3.88,3.88,0,0,1-.64,2.22,3.7,3.7,0,0,1-1.8,1.39,3.56,3.56,0,0,1,2.07,1.33A3.85,3.85,0,0,1,26.54,23,4.5,4.5,0,0,1,25,26.71,7.13,7.13,0,0,1,20.49,28Zm3.52-7.43v4.61h3a2.91,2.91,0,0,0,1.93-.59A2,2,0,0,0,23,23a2.14,2.14,0,0,0-2.42-2.38Zm0-2.48H20c1.77,0,2.66-.74,2.66-2.13A2,2,0,0,0,22,14.3a3.54,3.54,0,0,0-2.12-.51H17.38Z"
      transform="translate(0 0)"
    />
  </svg>
);

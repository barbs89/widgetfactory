...
// The following function receives two lots of data from the API (It pulls an advert and the adverts id, provides it to fetchImages function to retrieve the corresponding image //
